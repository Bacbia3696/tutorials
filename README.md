...
- `convex_hull/`: Andrew's monotonic chain tracing with orientation checks and hull assembly
- `line_sweep/`: interval endpoint sweep tracing for active count and max overlap checkpoints
...
- `http://localhost:4173/convex_hull/`
...
- `trie/`, `kmp/`, `segment_tree/`, `sparse_segment_tree/`, `fenwick_tree/`, `dsu/`, `dijkstra/`, `bellman_ford/`, `kruskal/`, `convex_hull/`, `line_sweep/`, `eulerian_path/`, `topological_sort/`
